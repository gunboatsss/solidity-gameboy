...
/// @notice Golden framebuffer battery, slim build (core readMem, slim slots).
...
contract PpuGoldensTest is Test {
    ...
    // storage slots (verify with `FOUNDRY_PROFILE=deploy forge inspect GameBoy storage-layout`)
